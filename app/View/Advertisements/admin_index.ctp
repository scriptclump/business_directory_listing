...
<div class="page-head">
   <ol class="breadcrumb">
      <!-- <li class="active"><i class="fa fa-plus-square"></i>&nbsp;<?php echo $this->Html->link(__('New Advertisement'), array('action' => 'add')); ?></li> -->
   </ol>
</div>
<div class="block block-color primary">
   <div class="header">
      <h3><?php echo __('Advertisements'); ?></h3>
   </div>
   <div class="content">
      <div class="row">
      ...
      <div class="row">&nbsp;</div>
      <?php echo $this->Form->create('Advertisement', array('action' => 'bulk_action/','onsubmit'=>'return confirm("Are you sure, you want to perform the bulk actions?");')); ?>
               ...
               <table class="table table-bordered" id="datatable2" >
                  <thead>
                     <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('cmspage_id','Page'); ?></th>
                        <th><?php echo $this->Paginator->sort('ad_pos','Position'); ?></th>
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td><?php echo $this->Form->checkbox('del_item.', array('class' => 'del_item', 'hiddenField' => false, 'value' => $advertisement['Advertisement']['id'] ) ); ?></td>
                        <td><?php echo h($advertisement['Advertisement']['id']); ?></td>
                        <td><?php echo h( $this->Text->truncate( $advertisement['Advertisement']['title'], 50,
                                  array(
                                      'ellipsis' => '...',
                                      'exact' => false
                                  )) );  ?>
                        </td>
                        <td><?php echo $this->Html->link($advertisement['Cmspage']['title'], array('controller' => 'cmspages', 'action' => 'view', $advertisement['Cmspage']['id'])); ?></td>
                        <td><?php echo ($advertisement['Advertisement']['ad_pos'] == 1) ? "Top" : "Left"; ?></td>
                        <td><?php echo h($advertisement['Advertisement']['sort_order']); ?></td>
                        <td align="center"><?php echo $this->Html->link($this->Html->image('icon_' . $advertisement['Advertisement']['status'] . '.png'), array('controller' => 'advertisements', 'action' => 'switch', 'status', $advertisement['Advertisement']['id']), array('class' => 'status', 'escape' => false)); ?></td>
                       <!--  <td><?php echo h($advertisement['Advertisement']['created']); ?></td>
                        <td><?php echo h($advertisement['Advertisement']['modified']); ?></td> -->
                        <td>
                           <div class="btn-group">
                              ...
                              <ul role="menu" class="dropdown-menu">
                                 <li><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $advertisement['Advertisement']['id'])); ?></li>
                                 <li><?php echo $this->Html->link(__('Details'), array('action' => 'view', $advertisement['Advertisement']['id'])); ?></li>
                                 <li class="divider"></li>
                                 <li>
                                   <?php
                                       echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $advertisement['Advertisement']['id']), null, __('Are you sure you want to delete # %s?', $advertisement['Advertisement']['id']));
                                       ?>
                                 </li>
                              </ul>
                           </div>
                  ...
                  <div class="col-sm-12">
                     ...
                     <div class="pull-right">
                        <div class="dataTables_paginate paging_bs_normal" id="datatable2_paginate">
                           <?php if( $this->Paginator->params['paging']['Advertisement']['pageCount'] > 1 ){ ?>
                           <ul class="pagination">
                              <?php
