...
<div class="page-head">
   <ol class="breadcrumb">
     <!--  <li class="active"><i class="fa fa-plus-square"></i>&nbsp;<?php echo $this->Html->link(__('New State'), array('action' => 'add')); ?></li> -->
   </ol>
</div>
<div class="block block-color primary">
   ...
   <div class="content">
            ...
            <div class="bs_border_container">
               ...
               <div class="content">
                  <?php
                     ...
                     echo $this->Form->input('state_name', array('class' => 'form-control parsley-validated', 'placeholder' => 'Enter the state name' ));
      ...
      <div class="row">&nbsp;</div>
      <?php echo $this->Form->create('State', array('action' => 'bulk_action/','onsubmit'=>'return confirm("Are you sure, you want to perform the bulk actions?");')); ?>
               ...
               <table class="table table-bordered" id="datatable2" >
                  ...
                  <tbody>
                  	<?php foreach ($states as $state): ?>
						<tr>
							<td><?php echo $this->Form->checkbox('del_item.', array('class' => 'del_item', 'hiddenField' => false, 'value' => $state['State']['id'] ) ); ?></td>
						 ...
						 <td>
							...
							<td align="center"><?php echo $this->Html->link($this->Html->image('icon_' . $state['State']['status'] . '.png'), array('controller' => 'states', 'action' => 'switch', 'status', $state['State']['id']), array('class' => 'status', 'escape' => false)); ?></td>
							<!-- <td>
                        <div class="btn-group">
                           ...
                           <ul role="menu" class="dropdown-menu">
                              <li><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $state['State']['id'])); ?></li>
                              <li><?php echo $this->Html->link(__('Details'), array('action' => 'view', $state['State']['id'])); ?></li>
                              <li class="divider"></li>
                              <li>
                                 <?php
                  ...
                  <div class="col-sm-12">
                     ...
                     <div class="pull-right">
                        <div class="dataTables_paginate paging_bs_normal" id="datatable2_paginate">
                           <?php if( $this->Paginator->params['paging']['State']['pageCount'] > 1 ){ ?>
                           <ul class="pagination">
                              <?php
