...
<div class="page-head">
   <ol class="breadcrumb">
      <li class="active"><i class="fa fa-plus-square"></i>&nbsp;<?php echo $this->Html->link(__('New Page'), array('action' => 'add')); ?></li>
   </ol>
</div>
<div class="block block-color primary">
   ...
   <div class="content">
      ...
      <div class="row">&nbsp;</div>
      <?php echo $this->Form->create('Cmspage', array('action' => 'bulk_action/','onsubmit'=>'return confirm("Are you sure, you want to perform the bulk actions?");')); ?>
               ...
               <table class="table table-bordered" id="datatable2" >
                  <thead>
                     <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('parent_id', 'Parent Page'); ?></th>
                        <th><?php echo $this->Paginator->sort('slug','URL'); ?></th>
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td><?php echo $this->Form->checkbox('del_item.', array('class' => 'del_item', 'hiddenField' => false, 'value' => $cmspage['Cmspage']['id'] ) ); ?></td>
                        <td><?php echo h($cmspage['Cmspage']['id']) ?></td>
                        <td><?php echo h( $this->Text->truncate( $cmspage['Cmspage']['title'], 50,
                                  array(
                                      'ellipsis' => '...',
                                      'exact' => false
                                  )) );  ?>
                        <td><?php if($cmspage['ParentCmspage']['id'] != 0) {
    ...
    $this->Text->truncate( $cmspage['Cmspage']['slug'], 50,
                                  array(
                                      'ellipsis' => '...',
                                      'exact' => false
                                  )),
    '/'.$cmspage['Cmspage']['slug'],
    array('target' => '_blank')
); ?>
                        </td>
                        <td align="center"><?php echo $this->Html->link($this->Html->image('icon_' . $cmspage['Cmspage']['status'] . '.png'), array('controller' => 'cmspages', 'action' => 'switch', 'status', $cmspage['Cmspage']['id']), array('class' => 'status', 'escape' => false)); ?></td>
                        <td>
                           <div class="btn-group">
                              ...
                              <ul role="menu" class="dropdown-menu">
                                 <li><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $cmspage['Cmspage']['id'])); ?></li>
                                 <li><?php echo $this->Html->link(__('Details'), array('action' => 'view', $cmspage['Cmspage']['id'])); ?></li>
                                 <li class="divider"></li>
                                 <li>
                                    <?php
                                       echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $cmspage['Cmspage']['id']), null, __('Are you sure you want to delete # %s?', $cmspage['Cmspage']['id']));
                                       ?>
                                 </li>
                              </ul>
                           </div>
                  ...
                  <div class="col-sm-12">
                     ...
                     <div class="pull-right">
                        <div class="dataTables_paginate paging_bs_normal" id="datatable2_paginate">
                           <?php if( $this->Paginator->params['paging']['Cmspage']['pageCount'] > 1 ){ ?>
                           <ul class="pagination">
                              <?php
