...
<div class="page-head">
   <ol class="breadcrumb">
      <li class="active"><i class="fa fa-plus-square"></i>&nbsp;<?php echo $this->Html->link(__('New Busniess'), array('action' => 'add')); ?></li>
   </ol>
</div>
<div class="block block-color primary">
   <div class="header">
      <h3><?php echo __('Busniesses'); ?></h3>
   </div>
   <div class="content">
      <div class="row">
            ...
            <div class="bs_border_container">
               ...
               <div class="content">
                  <?php
                     ...
                     echo $this->Form->input('status', array('options' => array('' => 'Select status', '1' => 'Active', '0' => 'Inactive')));
                  ?>
      ...
      <div class="row">&nbsp;</div>
      <?php echo $this->Form->create('Busniess', array('action' => 'bulk_action/','onsubmit'=>'return confirm("Are you sure, you want to perform the bulk actions?");')); ?>
               ...
               <table class="table table-bordered" id="datatable2" >
                  ...
                  <tbody>
                     <?php //echo $this->Text->excerpt($lastParagraph, 'method', 50, '...');
                        foreach ($busniesses as $busniess): ?>
                     <tr>
                        <td><?php echo $this->Form->checkbox('del_item.', array('class' => 'del_item', 'hiddenField' => false, 'value' => $busniess['Busniess']['id'] ) ); ?></td>
                        <td><?php echo h($busniess['Busniess']['id']); ?></td>
                        <td><?php echo h( $this->Text->truncate( $busniess['Busniess']['name'], 50,
                                  array(
                                      'ellipsis' => '...',
                                      'exact' => false
                                  )) );  ?>
                        ...
                        <td align="center"><?php echo $this->Html->link($this->Html->image('icon_' . $busniess['Busniess']['status'] . '.png'), array('controller' => 'busniesses', 'action' => 'switch', 'status', $busniess['Busniess']['id']), array('class' => 'status', 'escape' => false)); ?></td>
                        ...
                        <td>
                           <div class="btn-group">
                              ...
                              <ul role="menu" class="dropdown-menu">
                                 <li><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $busniess['Busniess']['id'])); ?></li>
                                 <li><?php echo $this->Html->link(__('Details'), array('action' => 'view', $busniess['Busniess']['id'])); ?></li>
                                 <li class="divider"></li>
                                 <li>
                                    <?php
                                       echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $busniess['Busniess']['id']), null, __('Are you sure you want to delete # %s?', $busniess['Busniess']['id']));
                                       ?>
                                 </li>
                              </ul>
                           </div>
