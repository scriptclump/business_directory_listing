	<div class="page-head"><ol class="breadcrumb">
   		<li><i class="fa fa-pencil-square-o"></i>&nbsp;<?php echo $this->Html->link(__('Edit Banner'), array('action' => 'edit', $slidingBanner['SlidingBanner']['id'])); ?> </li>
		<!-- <li><i class="fa fa-times"></i>&nbsp;<?php echo $this->Form->postLink(__('Delete Banner'), array('action' => 'delete', $slidingBanner['SlidingBanner']['id']), null, __('Are you sure you want to delete # %s?', $slidingBanner['SlidingBanner']['id'])); ?> </li>
		<li><i class="fa fa-plus-square"></i>&nbsp;<?php echo $this->Html->link(__('New Banner'), array('action' => 'add')); ?> </li> -->
  </ol></div>
