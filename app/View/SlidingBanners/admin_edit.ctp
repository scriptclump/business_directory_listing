...
<div class="page-head">
	<ol class="breadcrumb">
		<li><i class="fa fa-bars"></i>&nbsp;<?php echo $this->Html->link(__('List Banners'), array('action' => 'index')); ?></li>
...
<div class="block block-color primary">
  ...
  <div class="content">
	<?php
		...
		echo '<div class="form-group required">
					<label class="col-sm-2 control-label" for="SlidingBannerTitle">&nbsp;</label>
					<div class="col-sm-10"><strong>Kindy upload 990x366 pixel image for proper output.</strong></div>
				   </div>';
