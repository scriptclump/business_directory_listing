...
<div class="page-head">
   <ol class="breadcrumb">
      <!-- <li class="active"><i class="fa fa-plus-square"></i>&nbsp;<?php echo $this->Html->link(__('New ListingType'), array('action' => 'add')); ?></li> -->
   </ol>
</div>
<div class="block block-color primary">
   <div class="header">
      <h3><?php echo __('Listing Types'); ?></h3>
   </div>
   <div class="content">
      <div class="row">
      ...
      <div class="row">&nbsp;</div>
      <?php echo $this->Form->create('ListingType', array('action' => 'bulk_action/','onsubmit'=>'return confirm("Are you sure, you want to perform the bulk actions?");')); ?>
            ...
            <div id="datatable2_wrapper" class="dataTables_wrapper form-inline no-footer">
               <table class="table table-bordered" id="datatable2" >
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td><?php echo $this->Form->checkbox('del_item.', array('class' => 'del_item', 'hiddenField' => false, 'value' => $listingType['ListingType']['id'] ) ); ?></td>
                        <td><?php echo h($listingType['ListingType']['id']); ?></td>
                        <td><?php echo h( $this->Text->truncate( $listingType['ListingType']['title'], 50,
                                  array(
                                      'ellipsis' => '...',
                                      'exact' => false
                                  )) );  ?>
                        </td>
                        <td align="center"><?php echo $this->Html->link($this->Html->image('icon_' . $listingType['ListingType']['status'] . '.png'), array('controller' => 'listingTypes', 'action' => 'switch', 'status', $listingType['ListingType']['id']), array('class' => 'status', 'escape' => false)); ?></td>
                        <td><?php echo h($listingType['ListingType']['created']); ?></td>
                        <td><?php echo h($listingType['ListingType']['modified']); ?></td>
                        <td>
                           <div class="btn-group">
                              ...
                              <ul role="menu" class="dropdown-menu">
                                 <li><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $listingType['ListingType']['id'])); ?></li>
                                 <li><?php echo $this->Html->link(__('Details'), array('action' => 'view', $listingType['ListingType']['id'])); ?></li>
                                 <li class="divider"></li>
                                 <li>
                                    <?php
                                       echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $listingType['ListingType']['id']), null, __('Are you sure you want to delete # %s?', $listingType['ListingType']['id']));
                                       ?>
                                 </li>
                              </ul>
                           </div>
                  ...
                  <div class="col-sm-12">
                     ...
                     <div class="pull-right">
                        <div class="dataTables_paginate paging_bs_normal" id="datatable2_paginate">
                           <?php if( $this->Paginator->params['paging']['ListingType']['pageCount'] > 1 ){ ?>
                           <ul class="pagination">
                              <?php
