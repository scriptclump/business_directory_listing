...
<div class="page-head">
	<ol class="breadcrumb">
		...
		<li><i class="fa fa-times"></i>&nbsp;<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Membership.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Membership.id'))); ?></li>
 	</ol>
</div>
<div class="block block-color primary">
  <div class="header">
    <h3><?php echo __('Edit Membership'); ?></h3>
  </div>
  <div class="content">
	<?php
		$inputDefaults = array(
