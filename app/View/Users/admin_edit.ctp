...
<div class="block block-color primary">
  ...
  <div class="content">
	<?php
		...
		echo $this->Form->input('Business.fname', array('class' => 'form-control parsley-validated', 'required' => 'required',  'label' => array('class' => 'col-sm-2 control-label', 'text' => 'First Name') ));
		echo $this->Form->input('Business.lname', array('class' => 'form-control parsley-validated', 'required' => 'required',  'label' => array('class' => 'col-sm-2 control-label', 'text' => 'Last Name') ));
	?>
...
<?php
$this->Js->get('#BusinessCityId')->event('change',
  $this->Js->request(array(
    'controller'=>'users',
    'action'=>'admin_city_to_departmentAjax'
    ), array(
    'update'=>'#BusinessDepartmentId',
    'async' => true,
    'method' => 'post',
    'dataExpression'=>true,
