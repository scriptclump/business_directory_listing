...
<div class="page-head">
   <ol class="breadcrumb">
      <!-- <li class="active"><i class="fa fa-plus-square"></i>&nbsp;<?php echo $this->Html->link(__('New City'), array('action' => 'add')); ?></li> -->
   </ol>
</div>
<div class="block block-color primary">
   ...
   <div class="content">
            ...
            <div class="bs_border_container">
               ...
               <div class="content">
                  <?php
                     ...
                     echo $this->Form->input('city_name', array('class' => 'form-control parsley-validated', 'placeholder' => 'Enter the city name' ));
                     echo $this->Form->input('state_iso', array('class' => 'form-control parsley-validated', 'placeholder' => 'Enter the state name' ));
      ...
      <div class="row">&nbsp;</div>
      <?php echo $this->Form->create('City', array('action' => 'bulk_action/','onsubmit'=>'return confirm("Are you sure, you want to perform the bulk actions?");')); ?>
               ...
               <table class="table table-bordered" id="datatable2" >
                  ...
                  <tbody>
                  	<?php foreach ($cities as $city): ?>
						<tr>
							<td><?php echo $this->Form->checkbox('del_item.', array('class' => 'del_item', 'hiddenField' => false, 'value' => $city['City']['id'] ) ); ?></td>
						<!-- 	<td><?php echo h($city['City']['id']); ?></td> -->
							<td><?php echo h($city['City']['city_name']); ?></td>
							<td><?php echo h($city['City']['state_iso']); ?></td>
							<!-- <td><?php echo h($city['City']['zip_code']); ?></td> -->
							<td align="center"><?php echo $this->Html->link($this->Html->image('icon_' . $city['City']['status'] . '.png'), array('controller' => 'cities', 'action' => 'switch', 'status', $city['City']['id']), array('class' => 'status', 'escape' => false)); ?></td>
						<!-- 	<td>
	                           <div class="btn-group">
	                              ...
	                              <ul role="menu" class="dropdown-menu">
	                                 <li><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $city['City']['id'])); ?></li>
	                                 <li><?php echo $this->Html->link(__('Details'), array('action' => 'view', $city['City']['id'])); ?></li>
	                                 <li class="divider"></li>
	                                 <li>
	                                    <?php
	                                       echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $city['City']['id']), null, __('Are you sure you want to delete # %s?', $city['City']['id']));
	                                       ?>
	                                 </li>
	                              </ul>
	                           </div> 
                     ...
                     <div class="pull-left">
                        <div class="dataTables_length" id="datatable2_length">
                           <label>
                              ...
                              'options' => array('' => 'Bulk Actions', 'activate' => 'Activate', 'deactivate' => 'Deactivate'),
                              'class' => 'form-control',
                              'div' => false,
                              'label' => false
                              ));
                  ...
                  <div class="col-sm-12">
                     ...
                     <div class="pull-right">
                        <div class="dataTables_paginate paging_bs_normal" id="datatable2_paginate">
                           <?php if( $this->Paginator->params['paging']['City']['pageCount'] > 1 ){ ?>
                           <ul class="pagination">
                              <?php
