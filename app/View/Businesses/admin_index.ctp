...
<div class="page-head">
   <ol class="breadcrumb">
      <li class="active"><i class="fa fa-plus-square"></i>&nbsp;<?php echo $this->Html->link(__('New Business'), array('action' => 'add')); ?></li>
   </ol>
</div>
<div class="block block-color primary">
   <div class="header">
      <h3><?php echo __('Businesses'); ?></h3>
   </div>
   <div class="content">
      <div class="row">
            ...
            <div class="bs_border_container">
               ...
               <div class="content">
                  <?php
                     ...
                     echo $this->Form->input('name', array('class' => 'form-control parsley-validated', 'placeholder' => 'Enter the name' ));
                     echo $this->Form->input('email', array('class' => 'form-control parsley-validated', 'placeholder' => 'Enter the email' ));
                     echo $this->Form->input('phone', array('class' => 'form-control parsley-validated', 'placeholder' => 'Enter the phone' ));
      ...
      <div class="row">&nbsp;</div>
      <?php echo $this->Form->create('Business', array('action' => 'bulk_action/','onsubmit'=>'return confirm("Are you sure, you want to perform the bulk actions?");')); ?>
            ...
            <div id="datatable2_wrapper" class="dataTables_wrapper form-inline no-footer">
               <table class="table table-bordered" id="datatable2" >
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td><?php echo $this->Form->checkbox('del_item.', array('class' => 'del_item', 'hiddenField' => false, 'value' => $business['Business']['id'] ) ); ?></td>
                        <td><?php echo h($business['Business']['id']); ?></td>
                        <td><?php echo h( $this->Text->truncate( $business['Business']['name'], 50,
                                  array(
                                      'ellipsis' => '...',
                                      'exact' => false
                                  )) );  ?>
                        </td>
                        <td><?php if($business['Business']['membership_id'] == 1){
                                    echo "Free";
                                  } else if($business['Business']['membership_id'] == 2){
                                    echo "Paid";
                                  } else{
                                    echo "Not mentined yet";
                                  } ?></td>
                        <td><?php echo h($business['Business']['alternate_email']); ?></td>
                        <td><?php echo h($business['Business']['phone']); ?></td>
                        <td align="center"><?php echo $this->Html->link($this->Html->image('icon_' . $business['Business']['status'] . '.png'), array('controller' => 'businesses', 'action' => 'switch', 'status', $business['Business']['id']), array('class' => 'status', 'escape' => false)); ?></td>
                        <td>
                           <div class="btn-group">
                              ...
                              <ul role="menu" class="dropdown-menu">
                                 <li><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $business['Business']['id'])); ?></li>
                                 <li><?php echo $this->Html->link(__('Details'), array('action' => 'view', $business['Business']['id'])); ?></li>
                                 <li class="divider"></li>
                                 <li>
                                    <?php
                                       echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $business['Business']['id']), null, __('Are you sure you want to delete # %s?', $business['Business']['id']));
                                       ?>
                                 </li>
                              </ul>
                           </div>
