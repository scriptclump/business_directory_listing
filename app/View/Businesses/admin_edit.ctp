...
$inputDefaults = array(
		...
		echo $this->Form->input('pname', array('class' => 'form-control parsley-validated' ));
		...
		echo $this->Form->input('phone', array('class' => 'form-control parsley-validated' ));
		...
		echo $this->Form->input('street', array('class' => 'form-control parsley-validated' ));
		...
		echo $this->Form->input('zip_code', array('class' => 'form-control parsley-validated' ));
	?>
