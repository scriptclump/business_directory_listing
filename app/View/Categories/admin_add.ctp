...
<div class="block block-color primary">
  ...
  <div class="content">
	<?php
		...
		echo $this->Form->input('ListingType', array('multiple' => 'checkbox',  'format' => array('before', 'label', 'between', 'input', 'error', 'after'),
				'label' => array('class' => 'col-sm-2 control-label'),
				'class' => 'col-sm-4 mul_check',
				'div' => 'form-group',
				'between' => '<div class="col-sm-10" style="height:75px; overflow: auto;">',
				'error' => array(
					'attributes' => array('wrap' => 'span', 'class' => 'help-inline')
				),
				'after' => '</div>'));
