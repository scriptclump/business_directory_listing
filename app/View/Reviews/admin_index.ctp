...
<div class="page-head">
   <ol class="breadcrumb">
      <li class="active"><i class="fa fa-plus-square"></i>&nbsp;<?php echo $this->Html->link(__('New Review'), array('action' => 'add')); ?></li>
   </ol>
</div>
<div class="block block-color primary">
   ...
   <div class="content">
            ...
            <div class="bs_border_container">
               ...
               <div class="content">
                  <?php
                     ...
                     echo $this->Form->input('status', array('options' => array('' => '(choose one)', '1' => 'Approved', '0' => 'Pending')));
                  ?>
      ...
      <div class="row">&nbsp;</div>
      <?php echo $this->Form->create('Review', array('action' => 'bulk_action/','onsubmit'=>'return confirm("Are you sure, you want to perform the bulk actions?");')); ?>
               ...
               <table class="table table-bordered" id="datatable2" >
                  <thead>
                     <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('comment_title'); ?></th>
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td><?php echo $this->Form->checkbox('del_item.', array('class' => 'del_item', 'hiddenField' => false, 'value' => $review['Review']['id'] ) ); ?></td>
                        <td><?php echo h($review['Review']['id']) ?></td>
                        <td>
							<?php echo $this->Html->link($review['Business']['name'], array('controller' => 'businesses', 'action' => 'view', $review['Business']['id'])); ?>
						</td>
                        <td><?php echo h($review['Review']['comment_title']);  ?></td>
                        <td align="center"><?php echo $this->Html->link($this->Html->image('icon_' . $review['Review']['status'] . '.png'), array('controller' => 'reviews', 'action' => 'switch', 'status', $review['Review']['id']), array('class' => 'status', 'escape' => false)); ?></td>
                        ...
                        <td>
                           <div class="btn-group">
                              ...
                              <ul role="menu" class="dropdown-menu">
                                 <!-- <li><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $review['Review']['id'])); ?></li> -->
                                 <li><?php echo $this->Html->link(__('Details'), array('action' => 'view', $review['Review']['id'])); ?></li>
                                 <li class="divider"></li>
                                 <li>
                                    <?php
                                       echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $review['Review']['id']), null, __('Are you sure you want to delete # %s?', $review['Review']['id']));
                                       ?>
                                 </li>
                              </ul>
                           </div>
                  ...
                  <div class="col-sm-12">
                     ...
                     <div class="pull-right">
                        <div class="dataTables_paginate paging_bs_normal" id="datatable2_paginate">
                          <?php if( $this->Paginator->params['paging']['Review']['pageCount'] > 1 ){ ?>
                           <ul class="pagination">
                              <?php
