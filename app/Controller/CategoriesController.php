 ...
 */
	...
	public function beforeFilter() {
		...
		$this->Auth->allow('index', 'view', 'listing_type_to_category_ajax');
    }
	...
	public function admin_index() {
		...
		$listingTypes = $this->Category->ListingType->find('list');
		$this->set(compact('categoriestree','listingTypes'));
	...
	public function admin_add() {
		...
		$listingTypes = $this->Category->ListingType->find('list', array(
	        'order' => array('ListingType.title' => 'asc')
	    ));
		$parents = $this->Category->generateTreeList('','','','--','');
		$this->set(compact('parents','listingTypes'));
	}
	...
	public function listing_type_to_category_ajax( $id ){
		return $categories = $this->Category->find('list', array(
			'fields'     => array('Category.title', 'Category.slug'),
			'conditions' => array('Category.status' => '1', 'Category.status' => '1'),
			'order'      => array('Category.title' => 'ASC')
	    ));
	}
}